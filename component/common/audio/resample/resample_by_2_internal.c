...
/**
  ...
  * @param  len: input length
  * @param  out: output, int (shifted 15 positions to the left, + offset 16384) (of length len/2)
  * @param  state: filter state array; length = 8
  * @retval None
  */
void ResampleDownBy2ShortToInt(const short *in, int len, int *out, int *state)
{
	int tmp0, tmp1, diff;
	int i;
...
/**
  ...
  * @param  in: input, short
  * @param  len: input length
  * @param  out: output, int (normalized, not saturated) (of length len*2)
  * @param  state: filter state array; length = 8
  * @retval None
  */
void ResampleUpBy2ShortToInt(const short *in, int len, int *out, int *state)
{
	int tmp0, tmp1, diff;
	int i;
...
/**
  * @brief  Interpolator.
  * @param  in: input, int (shifted 15 positions to the left, + offset 16384)
  * @param  len: input length
  * @param  out: output, int (shifted 15 positions to the left, + offset 16384) (of length len*2)
  * @param  state: filter state array; length = 8
  * @retval None
  */
void ResampleUpBy2IntToInt(const int *in, int len, int *out, int *state)
{
	int tmp0, tmp1, diff;
	int i;
...
/**
  ...
  * @retval None
  */
void ResampleUpBy2IntToShort(const int *in, int len, short *out, int *state)
{
	int tmp0, tmp1, diff;
	int i;
...
/**
  ...
  * @retval None
  */
void ResampleLPBy2IntToInt(const int* in, int len, int* out, int* state)
{
	int tmp0, tmp1, diff;
	int i;
