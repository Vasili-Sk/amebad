...
static mm_siso_t* siso_h264_rtsp_v2			= NULL;
...
void mmf2_example_v2_init(void)
{
	...
	siso_h264_rtsp_v2 = siso_create();
	if(siso_h264_rtsp_v2){
		siso_ctrl(siso_h264_rtsp_v2, MMIC_CMD_ADD_INPUT, (uint32_t)h264_v2_ctx, 0);
		siso_ctrl(siso_h264_rtsp_v2, MMIC_CMD_ADD_OUTPUT, (uint32_t)rtsp2_v2_ctx, 0);
		siso_start(siso_h264_rtsp_v2);
	}else{
