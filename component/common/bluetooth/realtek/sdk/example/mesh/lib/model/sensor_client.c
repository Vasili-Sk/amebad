    ...
    case MESH_MSG_SENSOR_DESCRIPTOR_STATUS:
        {
            ...
            {
                sensor_client_status_descriptor_t status_data = {0, 0, NULL};
    ...
    case MESH_MSG_SENSOR_COLUMN_STATUS:
        {
            ...
            if (NULL != pmodel_info->model_data_cb)
            {
                sensor_client_status_column_t status_data = {0, 0, NULL};
                status_data.property_id = pmsg->property_id;
    ...
    case MESH_MSG_SENSOR_SERIES_STATUS:
        {
            ...
            if (NULL != pmodel_info->model_data_cb)
            {
                sensor_client_status_series_t status_data = {0, 0, NULL};
                status_data.property_id = pmsg->property_id;
